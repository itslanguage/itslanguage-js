...
class Sdk {
  ...
  createBasicAuth(basicauth) {
    ...
    return new Promise(function(resolve, reject) {
      self._secureAjaxPost(url, formData)
        .catch(function(error) {
          reject(error);
        })
        .then(function(data) {
  ...
  listOrganisations() {
    ...
    return new Promise(function(resolve, reject) {
      self._secureAjaxGet(url).catch(function(error) {
        reject(new Error(error));
      }).then(function(data) {
        var organisations = [];
