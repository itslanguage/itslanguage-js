...
describe('Speech Challenge Recording API', () => {
  describe('create', () => {
    it('should make an authorised request', done => {
      ...
      recordings
        .create('ch4', { id: 'recording' })
        .then(() => {
          const createRequest = authorisedRequestSpy.calls.mostRecent();

          expect(createRequest.args).toEqual([
            'POST',
            '/challenges/speech/ch4/recordings',
            { id: 'recording' },
          ]);
          done();
        })
      ...
      recordings
        ...
        .then(() => {
          ...
          expect(getRequest.args).toEqual([
            'GET',
            '/challenges/speech/ch4/recordings/r3c',
          ]);
          done();
        })
        .catch(done.fail);
  ...
  describe('getAll', () => {
    ...
    it('should allow filters if they are a URLSearchParams object', done => {
      ...
      recordings
        ...
        .then(() => {
          ...
          expect(getRequest.args).toEqual([
            'GET',
            '/challenges/speech/ch4/recordings?theme=m30w',
          ]);
          done();
        })
        .catch(done.fail);
    ...
    it('should reject when something other than URLSearchParams is given as the filters', done => {
      recordings
        .getAll('ch4', 'this is not an instance of URLSearchParams')
        .then(done.fail)
        .catch(() => {
          done();
        });
  ...
  describe('record', () => {
    ...
    it('should record some data', done => {
      recordings
        .record('challengeId', recorderStub)
        .then(() => {
